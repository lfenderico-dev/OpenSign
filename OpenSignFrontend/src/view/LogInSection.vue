<template>
  ...
  <div class="bg-[url(@/assets/photo/AuthBg.webp)] bg-cover bg-top min-h-screen flex flex-col justify-center items-center">
    <h1 class="text-white mx-auto text-center pt-4 text-5xl font-bold pb-12">Create an account</h1>
    ...
    <div class="flex justify-center flex-col gap-4">
      ...
      <button @click="login" class="text-xl mx-auto block my-4 px-[25%] py-4 rounded-full font-bold bg-emerald-500 text-white shadow-2xl shadow-emerald-900 hover:transition hover:-translate-y-4 active:translate-y-0">LogIn</button>
    </div>
  </div>
</template>
